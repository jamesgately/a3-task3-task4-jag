...
Mean test diameters for purple urchins in our control (3.73 $\pm$ 0.87 cm, n = 62) were smaller than those in our annual treatment (3.92 $\pm$ 0.97 cm, n = 60) -- a difference of ~5% (values represent mean $\pm$ 1 standard deviation; t(117.7) = 1.15, p = 0.25). These results suggest that the winter removal of giant kelp at Naples Reef plays a role in the test size of purple urchins. Our analysis, however, was based on data obtained during one month in 2010; extending the timeframe of our analysis would allow us to better understand the effect that giant kelp recolonization may have on purple urchins.

Our probability value (p = 0.25) tells us that there is a 2.5% chance that we would find means **at least** as different as those above (see Table 1) by random chance if they were obtained from populations with the same mean test diameter.